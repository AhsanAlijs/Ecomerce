...
const Navbar = () => {
    ...
    return (
        <main onMouseLeave={() => setMousehover(false)}>
            ...
            <article className='bg-[#F4F4F4] flex items-center justify-between flex-wrap p-4' >

                <div
                    onMouseEnter={() => setMousehover(true)}
                    className='flex gap-6 bg-[#EDA415] p-4 text-white w-full md:w-auto justify-between md:justify-center'
                >
                    Browse categories
                ...
                <div className='text-lg font-bold text-[#003F62] mt-4 md:mt-0'>
                    30 Days Free Return
                </div>

            </article>

            <ul className={`bg-[#F4F4F4] absolute rounded-lg shadow-xl flex items-start w-fit p-4 top-[230px] right-[20px] md:right-[700px] lg:right-[1039.8px] flex-col transform transition-all duration-300 ease-in-out  ${mouseHover ? 'opacity-100 translate-y-15 cursor-pointer ' : 'opacity-0 -translate-y-[100%]'}`}>
                <a className='hover:text-[#003F62]' href='#'>Laptops</a>
                <a className='hover:text-[#003F62]' href='#'>Mobiles</a>
                <a className='hover:text-[#003F62]' href='#'>Grocery</a>
                <a className='hover:text-[#003F62]' href='#'>Widgets</a>
                <a className='hover:text-[#003F62]' href='#'>Men Collection Brands</a>
                <a className='hover:text-[#003F62]' href='#'>Women Collection Brands</a>
            </ul>

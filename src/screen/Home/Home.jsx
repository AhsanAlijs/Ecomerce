...
const Home = () => {
    return (
        ...
        <main className='flex flex-col md:flex-row items-center justify-around bg-white p-4 md:p-8'>
            ...
            <div className='relative'>
                ...
                <div className='absolute flex flex-col px-4 py-3 md:px-[50px] md:py-[45px] top-[75%] md:top-[200px] right-[10%] md:left-[200px] bg-[#EDA415] rounded-full text-lg md:text-xl font-semibold text-white'>
                    <span>Only</span>
                    <span>$120</span>
                </div>
            </div>
